...
const BookContainer = () => {
  ...
  return (
    <Box
      component="section"
      sx={{ p: {xs: "20px", sm: "40px", md: "40px"}, border: "1px solid black", margin: {xs: "50px 20px 0", md: "50px 120px 0"} }}
    >
      <Button
        variant="contained"
      ...
      >
        ...
        <Typography variant="h5" component="p" sx={{ width: "100%" }}>
          Insert Book Details
        </Typography>
      </Button>
      ...
      {isInsertBook && (
        <BookForm
          books={books}
          setBooks={setBooks}
          setIsInsertBook={setIsInsertBook}
        />
      )}
